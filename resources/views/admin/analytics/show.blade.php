                    ...
                    <tbody class="divide-y text-sm">
                        @foreach (($ungrouped ?? false) ? $links : $group->links as $link)
                            <tr class="hover:bg-muted/20">
                                ...
                                <td class="px-4 py-4">
                                    <a href="{{ url('/click/' . $link->short_url . '/' . ($link->denomination->slug)) }}"
                                        target="_blank" class="text-muted-foreground hover:text-primary hover:underline">
                                        /click/{{ $link->short_url }}/{{ $link->denomination->slug  }}
                                    </a>
                                </td>
                                <td class="px-4 py-4">
                                    <span
